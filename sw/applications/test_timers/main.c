...
#define INTERRUPT_TOLERANCE 100     // cycles tolerance for timer interrupt
...
int main(){
    ...
    uint32_t freq_hz = 1000000;//soc_ctrl_get_frequency(&soc_ctrl);
    ...
    timer_wait_us(50000);       // Wait for 5 seconds
    timer_cycles = timer_stop();
    PRINTF("Done\n\r");
